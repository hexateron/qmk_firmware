...
#if defined(ENCODER_ENABLE) && defined(PAL_USE_CALLBACKS) && defined(HXN_ALLOW_PAL_CALLBACKS) //HXN: Depends on Quantum encoder changes from Keychron fork @ 7f2d19d9
